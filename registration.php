<?php
$pageTitle = "Register | GlamStyle Fashion";
include 'header.php';
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card shadow p-4 position-relative">
                <!-- Back to Login Button inside card top-right -->
                <a href="login.php" class="btn btn-outline-secondary position-absolute" style="top: 15px; right: 15px;">Back to Login</a>
               ...
               <h3 class="text-center mb-4" style="color: #e91e63;">Register</h3>
                ...
                <form method="POST" action="registration.php" id="registerForm">
                    ...
                    <div class="d-grid">
                       <button type="submit" class="btn btn-lg text-white" style="background-color: palevioletred; border: none;">Register</button>
                    </div>
                    <div class="text-center mt-3">
    <a href="login.php" style="color: #e91e63;">Already have an account? Login here</a>
